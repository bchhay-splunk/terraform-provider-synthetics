...
resource "synthetics_create_downtime_configuration_v2" "downtime_configuration_v2_foo_recurring" {
  ...
  downtime_configuration {
    ...
    end_time = "2025-03-25T18::13.000Z"
    test_ids = [932826]
    recurrence {
      repeats {
        type = "daily"
		...
		Steps: []resource.TestStep{
			// Create It
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("synthetics_create_downtime_configuration_v2.downtime_configuration_v2_foo_recurring", "downtime_configuration.0.end_time", "2025-03-25T18::13.000Z"),
					resource.TestCheckResourceAttr("synthetics_create_downtime_configuration_v2.downtime_configuration_v2_foo_recurring", "downtime_configuration.0.recurrence.repeats.type", "daily"),
					resource.TestCheckResourceAttr("synthetics_create_downtime_configuration_v2.downtime_configuration_v2_foo_recurring", "downtime_configuration.0.recurrence.end.type", "on"),
					resource.TestCheckResourceAttr("synthetics_create_downtime_configuration_v2.downtime_configuration_v2_foo_recurring", "downtime_configuration.0.recurrence.end.value", "2025-04-25"),
				),
			},
			{
